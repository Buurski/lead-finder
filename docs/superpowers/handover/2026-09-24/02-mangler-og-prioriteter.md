...
2. Rigtig opvarmning: nyt domæne-send → maks ~20/dag i starten, 22–45 s pause (findes), ingen billeder/tracking-pixels, og list-unsubscribe-header (mangler — tjek). **Afgjort 25/9 (bølge 2):** loft = atomisk dagsbudget 20/konto delt af kold-kø og preview-send. List-Unsubscribe **fravalgt** efter A/B-testmail: med header → Gmail Promotions, uden → Primær (SPF/DKIM/DMARC pass i begge); Gmails krav gælder først >5000/dag. Afmeld-teksten i selve mailen ("skriv tilbage") bevares. Se plan fase 5, bølge 2.
