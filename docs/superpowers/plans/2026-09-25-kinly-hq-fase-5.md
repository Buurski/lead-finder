...
7c. Google Kalender (Lucas 25/9: direkte i lucas@kinly.dk): del lucas@kinly.dk-kalenderen med `lead-system@leads-494721.iam.gserviceaccount.com` ("Foretag ændringer i begivenheder"), sæt `HQ_GCAL_LUCAS=lucas@kinly.dk` i Vercel. Sikkert: synken lister/sletter kun begivenheder med `kinlyHq=1`. Google Calendar API + Search Console API skal være slået til i GCP-projektet leads-494721. Uden env logger calendar-sync "ikke sat op".
