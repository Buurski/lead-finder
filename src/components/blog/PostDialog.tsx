...
export default function PostDialog({
  ...
  const dirty = post ? title !== post.title || slug !== post.slug || category !== post.category || excerpt !== post.excerpt : false;
    ...
    >
      <div className="bl-dialog cc-card" role="dialog" aria-modal="true" aria-label="Blogindlæg">
        <div className="bl-dialog-head">
          ...
          <button type="button" className="bl-close-btn cc-focus" onClick={onClose} aria-label="Luk">
        ...
        {!loading && post && (
          <div className="bl-dialog-body">
            ...
            <section className="bl-section">
              ...
              {!post.images.a && !post.images.b ? (
                ...
                <>
                  ...
                  <div className="bl-dialog-actions">
                    <button type="button" className="cc-btn" data-on={post.images.choice === "a"} disabled={busy || !post.images.a} onClick={() => chooseImage("a")}>Vælg A</button>
                    <button type="button" className="cc-btn" data-on={post.images.choice === "b"} disabled={busy || !post.images.b} onClick={() => chooseImage("b")}>Vælg B</button>
                    <button type="button" className="cc-btn" data-on={post.images.choice === "both"} disabled={busy || !post.images.a || !post.images.b} onClick={() => chooseImage("both")}>Begge (A = hero, B i teksten)</button>
                  </div>
                </>
              )}
            </section>
            ...
            <section className="bl-section">
              ...
              <div className="bl-dialog-actions">
                <button type="button" className="cc-btn cc-focus" aria-label="Forrige fase" onClick={() => moveStage(-1)} disabled={busy || idx <= 0}>
