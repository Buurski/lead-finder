...
export const config = {
  ...
  matcher: ["/((?!_next/|api/health|api/cron/|api/kalender/|api/hermes/status|api/hermes/crm-dossier$|api/agent/log$|seo-tjek$|seo-tjek/rapport/|api/seo-tjek/submit|api/seo-tjek/unsubscribe|login$|api/auth/magic$|api/auth/verify$|studio/demo-site/|favicon.ico|.*\\.(?:png|jpg|jpeg|svg|ico|webp|css|js|woff2?)$).*)"],
};
